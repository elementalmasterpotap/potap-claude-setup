...
def get_content(ts: str) -> list:
    ...
    settings = [
        ...
        {"tag": "pre", "children": [
            ...
            "│   ├── UserPromptSubmit → haiku-suggest.py  (complexity scoring → [HAIKU_ELIGIBLE])\n"
    ...
    infra = [
        ...
        {"tag": "pre", "children": [
            ...
            "├── scripts/                   хуки: 1 UserPromptSubmit + 1 PreToolUse + 12 Stop + 3 PostToolUse\n"
            "├── skills/                    10 action + 5 knowledge скиллов\n"
    ...
    summary = [
        ...
        {"tag": "pre", "children": [
            ...
            "Haiku-анализатор      haiku-suggest.py (UPS)       complexity scoring → [HAIKU_ELIGIBLE]\n"
        ...
        {"tag": "pre", "children": [
            ...
            "Pre-compact бэкап     hooks.PreCompact             транскрипт до сжатия\n"
